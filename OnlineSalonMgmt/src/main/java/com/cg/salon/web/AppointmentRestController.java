...
public class AppointmentRestController {
	...
	public AppointmentSuccessMessage addAppointment(@Valid @RequestBody AppointmentDto appdto, BindingResult br) throws SalonServiceNotFoundException, ValidateAppointmentException, CustomerNotFoundException, SalonServiceScheduleNotFoundException {
		if (br.hasErrors())
	...
	public AppointmentSuccessMessage editAppointment(@Valid @RequestBody AppointmentDto appdto, BindingResult br) throws SalonServiceNotFoundException, AppointmentNotFoundException, ValidateAppointmentException, CustomerNotFoundException, SalonServiceScheduleNotFoundException {
		if (br.hasErrors())
		{
			throw new ValidateAppointmentException(br.getFieldErrors());
		}
		service.editAppointment(appdto);
		return new AppointmentSuccessMessage(SalonConstraints.APPOINTMENT_EDITTED);
	}
	...
	public AppointmentSuccessMessage removeAppointment(@PathVariable ("appid") int appointmentId) throws AppointmentNotFoundException {
		...
		return new AppointmentSuccessMessage(SalonConstraints.APPOINTMENT_DELETED);
	}
